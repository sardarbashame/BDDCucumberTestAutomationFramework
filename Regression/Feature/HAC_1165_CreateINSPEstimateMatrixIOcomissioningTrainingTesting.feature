Feature: Verify HAC_1165_CreateINSP Estimate Matrix
  ...
  Scenario Outline: Login as service user and HAC_1165_Create INSP Estimate Matrix  IO/comissioning+Training+Testing
    ...
    Examples: 
      ...
      | mubeen.mohiuddin@gerent.com.qa | Strange@234 | FN6 MN6 LN6 | FN6           | TestCase100 | USA Domestic Market Rate | ISHIDA DACS / CEIA       | IO/Commissioning + Training + Testing |
