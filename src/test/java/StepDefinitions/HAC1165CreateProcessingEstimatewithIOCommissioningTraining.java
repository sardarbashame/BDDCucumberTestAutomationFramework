...
public class HAC1165CreateProcessingEstimatewithIOCommissioningTraining extends CommonFunctions {
	...
	@Given("^HAC1165CT user enters (.*) and (.*)$")
	...
	public void HAC1165CT_click_on_cases_tab() throws InterruptedException {
		homePage = new HomePage();
		homePage.clickCasesTab();
	}

	@When("HAC1165CT create new case")
	public void HAC1165CT_create_new_case() throws InterruptedException, IOException  {
		homePage = new HomePage();
	...
	public void HAC1165CT_user_is_on_estimate_tab() throws InterruptedException, IOException {
	...
	public void HAC1165CT_verify_the_pricebook_options() throws InterruptedException, IOException {
		estimateCreationFlowStep1 = new EstimateCreationFlowStep1();
	...
	public void HAC1165CT_verify_the_field_label_number_of_tech() throws InterruptedException, IOException {
	...
	public void HAC1165CT_verify_the_field_value_number_of_tech() throws InterruptedException, IOException {
		estimateCreationFlowStep2 = new EstimateCreationFlowStep2();
	...
	public void HAC1165CT_verify_the_field_label_number_of_days() throws InterruptedException, IOException {
		estimateCreationFlowStep2 = new EstimateCreationFlowStep2();
	...
	public void HAC1165CT_verify_the_field_label_number_of_hours() throws InterruptedException, IOException {
		estimateCreationFlowStep2 = new EstimateCreationFlowStep2();
	...
	public void HAC1165CT_seelct_from_date() throws InterruptedException, IOException {
		estimateCreationFlowStep2 = new EstimateCreationFlowStep2();
		estimateCreationFlowStep2.selectFromDate();
	}

	@When("HAC1165CT select to date")
	public void HAC1165CT_seelct_to_date() throws InterruptedException, IOException {
		estimateCreationFlowStep2 = new EstimateCreationFlowStep2();
		estimateCreationFlowStep2.selectToDate();
	}

	@When("HAC1165CT select view confirmation")
	public void HAC1165CT_seelct_view_confirmation() throws InterruptedException, IOException {
	...
	public void HAC1165CT_generate_estimate_pdf() throws InterruptedException, IOException {
		estimateCreationFlowStep3 = new EstimateCreationFlowStep3();
