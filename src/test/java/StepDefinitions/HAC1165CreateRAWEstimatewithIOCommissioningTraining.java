...
public class HAC1165CreateRAWEstimatewithIOCommissioningTraining extends CommonFunctions {
	...
	public void HAC1165RCT_click_on_cases_tab() throws InterruptedException {
		homePage = new HomePage();
		homePage.clickCasesTab();
	}

	@When("HAC1165RCT create new case")
	public void HAC1165RCT_create_new_case() throws InterruptedException, IOException  {
		homePage = new HomePage();
	...
	public void HAC1165RCT_user_is_on_estimate_tab() throws InterruptedException, IOException {
	...
	public void HAC1165RCT_verify_the_pricebook_options() throws InterruptedException, IOException {
		estimateCreationFlowStep1 = new EstimateCreationFlowStep1();
	...
	public void HAC1165RCT_select_values_on_estimate_flow_step1() throws InterruptedException, IOException {
		estimateCreationFlowStep1 = new EstimateCreationFlowStep1();
		estimateCreationFlowStep1.estimateFlowStep1("USA International MPA-PEPSICO (FRITOLAY)", "RAW Estimate Matrix",
				"ACF / AUTOMATIC CRATE FILLER", "IO/Commissioning + Training");
	}
